...
from .doctor_views import get_doctor_profile, get_doctor_patients, get_patient_details, get_patient_notes, get_pat_note_details,add_clinical_comment, regenerate_clinical_analysis, get_or_generate_clinical_summary
